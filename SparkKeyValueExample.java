...
public class SparkKeyValueExample {

	private static JavaSparkContext sc;

	public SparkKeyValueExample(JavaSparkContext sc) {
		this.sc = sc;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		SparkKeyValueExample job = new SparkKeyValueExample(sc);
		...
		System.out.println(output_rdd.collect().toString());
		sc.close();
	}
